...
You may also be interested in exploring the use of the FLAME method in Parodi and Reimherr (2016); a preprint and code implementing this method for the Activity data is available [here](./DataCode/Reimherr.zip).
