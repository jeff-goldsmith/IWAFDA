...
You may also be interested in exploring the use of the FLAME method in [Parodi and Reimherr](http://www4.stat.ncsu.edu/~staicu/papers/msFGRPL_R1.pdf) (2016); code implementing this method for the Activity data is available [here](./DataCode/Reimherr.zip).
